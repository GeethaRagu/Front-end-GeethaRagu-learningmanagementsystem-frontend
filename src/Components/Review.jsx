      ...
      <article>
        <div className="flex items-center mb-4 ">
          <img
            ...
            alt=""
          />
          <div className="font-medium text-gray-100 dark:text-white">
            <p>
              Jese Leos
              <time
                datetime="2014-08-16 19:00"
                className="block text-sm  text-gray-100 dark:text-gray-400"
              >
                Joined on June 2024
              </time>
            </p>
        ...
        <div className="flex items-center mb-1 space-x-1 rtl:space-x-reverse">
          ...
          <h3 className="ms-2 text-sm font-semibold text-gray-100 dark:text-white">
        ...
        <p className="mb-2 text-gray-100 dark:text-white text-wrap ">
        ...
        <p className="mb-3 text-gray-100 dark:text-white text-wrap">
