      ...
      <div className="px-5 flex max-w-full flex-col md:flex-row md:items-center">
        <div className=" flex flex-col sm:flex-row px-10">
          ...
          <div className="">
            ...
            <p className=" text-2xl pt-8 px-3">
              Tell me and I forgot.Teach me and I remember.
              <p className=" text-2xl px-3">Involve me and I learn.</p>
            </p>
            <p className="text-lg pt-8 px-3">-Benjamin Franklin</p>
          </div>
        </div>
        {!currentuser ? (
          <>
          ...
          <>
           ...
           <span className="text-lg px-3">Hello !</span><span className="text-2xl px-3">{currentuser.rest.username}</span>
           <br/><Link to="/courses" className="text-blue-300 px-3 text-md">Explore more</Link>
           </div>
          </>
        )}
      </div>
